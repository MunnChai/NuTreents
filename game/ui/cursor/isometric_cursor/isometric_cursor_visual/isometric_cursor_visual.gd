...
## This includes:
## - The arrow
## —> Changes form depending on available action (plant, dig, ...)
## —> Bobs up and down if said action is allowed
## —> Is placed at correct height relative to tile/structure
## - Modulation
## —> Including multi-tile modulation
## —> 
